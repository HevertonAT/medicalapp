...
export default function Dashboard() {
  ...
  const { data: stats = { total_patients: 0, appointments_count: 0, appointments_list: [] }, isLoading: loading } = useQuery<any>({
    queryKey: ['dashboard', currentDate.getFullYear(), currentDate.getMonth()],
    queryFn: async () => {
  ...
  const calendarEvents = stats.appointments_list.map((app: any) => {
